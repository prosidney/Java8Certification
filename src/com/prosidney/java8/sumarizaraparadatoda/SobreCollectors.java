...
import com.prosidney.java8.stream.*;
import com.prosidney.java8.stream.Transaction;
...
public class SobreCollectors {
    public static void main(String args[]){
        ...
        List<com.prosidney.java8.stream.Transaction> transactions = Arrays.asList(
                new com.prosidney.java8.stream.Transaction(brian, 2011, 300),
                new com.prosidney.java8.stream.Transaction(raoul, 2009, 1000),
                new com.prosidney.java8.stream.Transaction(raoul, 2011, 400),
                new com.prosidney.java8.stream.Transaction(mario, 2005, 710),
                new com.prosidney.java8.stream.Transaction(mario, 2012, 700),
                new com.prosidney.java8.stream.Transaction(alan, 2013, 950)
        );
